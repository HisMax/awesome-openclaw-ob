<p align="center">
  <img src="assets/readme-banner.jpg" width="100%" alt="OpenClaw 深度研究知识库" />
</p>
...
<p align="center">
  ...
  <img src="assets/competitive-landscape-2026.jpg" width="49%" alt="竞品格局 2026" />
</p>

<p align="center">
  <img src="assets/series-h.jpg" width="49%" alt="Anthropic Series H 融资" />
  <img src="assets/claw-chain.jpg" width="49%" alt="Claw Chain 四漏洞链" />
</p>
...
| 目录 | 篇数 | 主题 | 推荐入口 |
|:-----|:----:|:-----|:---------|
| `01-产品与架构` | 55 | 核心架构、执行循环、记忆系统、版本更新 | OpenClaw 是什么 → Agent Execution Loop |
| `02-安全与风险` | 45 | 漏洞分析、CVE、Claw Chain、安全态势 | 安全边界与风险（总览）→ Claw Chain 四漏洞链 |
| `03-竞品与市场` | 39 | Claude Code、Cursor、Devin、Copilot 对比 | 竞品对比总览 → Claude Code 分析 |
| `04-生态与社区` | 59 | MCP 协议、ClawHub、社区数据、ACP | MCP 协议 → OpenClaw 社区热度总览 |
| `05-商业与投资` | 26 | Anthropic 融资、市场规模、商业化 | Anthropic Series H → AI Agent 市场规模 |
| `06-趋势与未来` | 21 | Agent 元年、EU AI Act、技术成熟度 | 2026 Agent 元年 → AI Agent 技术成熟度 |
| `07-使用案例` | 18 | Citi Arc 平台、MFS Corp、真实案例 | 案例-Citi 银行 Arc 平台 |
| `08-基础概念` | 58 | Agentic AI、LLM、SWE-Bench、ACP | Agentic AI → Claude 模型系列 |
